      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Draft, review, approve, and copy emails. (Phase 1)
          </p>
        </div>
              ...
              <>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className={`text-xs px-2 py-0.5 rounded-full ${statusColor[selected.status as DraftStatus]}`}>
                      {selected.status}
                    </span>
                    ...
                    {(selected.suggestions ?? []).length === 0 ? (
                      ...
                      (selected.suggestions ?? [])
                        ...
                        .map((s: EmailDraftSuggestion) => (
                          <div key={s.id} className="bg-zinc-900 border border-zinc-800 rounded p-3 space-y-2">
