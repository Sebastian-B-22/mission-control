    ...
    <form onSubmit={handleSubmit} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-24 py-3.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-600 rounded-xl text-zinc-800 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-all shadow-sm text-base"
          autoComplete="off"
        />

        {/* Result count */}
        {resultCount !== undefined && (
          <span className="absolute right-10 top-1/2 -translate-y-1/2 text-xs text-zinc-400 dark:text-zinc-500 tabular-nums">
