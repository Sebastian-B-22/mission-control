  ...
  return (
    <div className="space-y-6">
      <WorkSurfacePageHeader
        title="Personal RPM"
        description="Life categories, purpose statements, yearly outcomes, and this month&apos;s needle movers."
      />
            ...
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <CardDescription className="mt-1">{category.role || "Life area"}</CardDescription>
                </div>
                <Button 
                  variant="ghost" 
                  size="sm" 
