...
const subProjectMeta: Record<string, { label: string; lane: string; icon: any; tone: string; badgeTone: string }> = {
  gtm: {
    ...
    icon: Target,
    tone: "border-cyan-400/30 bg-gradient-to-br from-cyan-500/22 via-sky-500/14 to-zinc-950 shadow-[0_0_0_1px_rgba(34,211,238,0.08)]",
  ...
  product: {
    ...
    lane: "Box + experience",
    icon: Package,
    tone: "border-violet-400/30 bg-gradient-to-br from-violet-500/22 via-fuchsia-500/14 to-zinc-950 shadow-[0_0_0_1px_rgba(167,139,250,0.08)]",
  ...
  curriculum: {
    ...
    icon: BookOpen,
    tone: "border-emerald-400/30 bg-gradient-to-br from-emerald-500/24 via-teal-500/14 to-zinc-950 shadow-[0_0_0_1px_rgba(52,211,153,0.08)]",
  ...
  marketing: {
    ...
    icon: Megaphone,
    tone: "border-amber-400/30 bg-gradient-to-br from-amber-500/24 via-orange-500/14 to-zinc-950 shadow-[0_0_0_1px_rgba(251,191,36,0.08)]",
  ...
  operations: {
    ...
    icon: Cog,
    tone: "border-rose-400/30 bg-gradient-to-br from-rose-500/22 via-red-500/14 to-zinc-950 shadow-[0_0_0_1px_rgba(251,113,133,0.08)]",
  ...
  const metricCards = [
    {
      ...
      sub: "Target: June 15",
      tone: "border-emerald-400/35 bg-gradient-to-br from-emerald-500/28 via-emerald-400/12 to-zinc-950",
    ...
    },
    {
      ...
      tone: "border-cyan-400/35 bg-gradient-to-br from-cyan-500/26 via-sky-500/12 to-zinc-950",
    ...
    },
    {
      ...
      tone: "border-amber-400/35 bg-gradient-to-br from-amber-500/26 via-orange-500/12 to-zinc-950",
