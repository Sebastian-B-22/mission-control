  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={generating}
            className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-500 disabled:bg-purple-800 text-white rounded-lg transition-colors"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Column - Today's Schedule (takes 2 cols on large) */}
        <div className="lg:col-span-2 space-y-6">
          <TodaySchedule />
          <WeeklyOverview />
        </div>

        {/* Right Column - Focus & Resources */}
        <div className="space-y-6">
          <QuarterlyFocus />
          <ResourceBrowser />
        </div>
